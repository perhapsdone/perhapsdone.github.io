            ...
            if (void 0 !== i) {
                ...
                for (var E, S = t.slidesPerColumn, C = x / S, M = Math.floor(d / t.slidesPerColumn), P = 0; P < d; P += 1) {
                    ...
                    if ("none" !== k.css("display")) {
                        ...
                        } else T = (i - (t.slidesPerView - 1) * g) / t.slidesPerView, t.roundLengths && (T = Math.floor(T)), l[P] && (e.isHorizontal() ? l[P].style.setProperty('width', T+'px', 'important') : l[P].style.height = T + "px");
